...
{
    public class WaterfallPanel2 : Panel
    {
        public static double itemDynamicWidth = 220; //每列元素的基准宽度
        ...
        protected override Size ArrangeOverride(Size finalSize)
        {
            ...
            int ColumnCount = (int)(finalSize.Width / itemDynamicWidth);
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            int ColumnCount = (int)(availableSize.Width / itemDynamicWidth);
            double flowWidth = availableSize.Width / ColumnCount;

            // 为子控件提供沿着流方向上，无限大的空间
            Size elemMeasureSize = new Size(flowWidth, availableSize.Height);
